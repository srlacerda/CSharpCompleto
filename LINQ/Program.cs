...
namespace LINQ
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            #region Sintaxe 1 - Expressao Lambda
            ...
            #region Sintaxe 2 -  Alternativa - LINQ com conotacao similar ao SQL
            //Where TODO PRODUTO P =>(TAL QUE) => Category.Tier == 1 AND Product.Preco < 900
            //var r1 = products.Where(p => p.Category.Tier == 1 && p.Price < 900.0);
            var r1 =
                from p in products
            ...
            var r4 =
                ...
                orderby p.Name //OrderBy na ordem invesrsa - neste caso ele primeiro orderna
                orderby p.Price //po preco e depois por nome
                select p;
            Print("TIER 1 ORDER BY PRICE THEN BY NAME", r4);
            ...
            #region Exercicio - Calcular Medio dos Produtos e retornar os produtos com preco abaixo da media
